  ...
  return (
    <footer className="footer">
      <div className="footer-top">
        ...
        <div className="footer-col">
          <h4>Contact Us</h4>
          <div className="footer-contact-item" onClick={() => window.location.href = 'tel:+8801234567890'} title="Tap to call">
          ...
          <div className="footer-contact-item" onClick={() => copyToClipboard('info@healthcareplus.com', 'Email copied!')} title="Click to copy email">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="footer-contact-item" onClick={() => navigate('/contact')} title="Find us on map">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="footer-col">
          ...
          <div className="footer-social">
            <a href="https://www.facebook.com/share/1DxQHAUD9v/" target="_blank" rel="noopener" title="Facebook">
            ...
            <a href="https://x.com/HCare_MHB" target="_blank" rel="noopener" title="X / Twitter">
